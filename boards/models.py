...
class Notification(models.Model):
    actor = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='actions')  # ссылка на юзера
...
class CardMovement(models.Model):
    ...
    to_list = models.ForeignKey(
        List, on_delete=models.CASCADE, related_name='to_movements')
    moved_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='card_movements')
